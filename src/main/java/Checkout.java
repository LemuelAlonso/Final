...
public class Checkout extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        shippingFeeField = new javax.swing.JTextField();
        ...
        getContentPane().add(paymentMethodbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 380, 40));
        ...
        getContentPane().add(paymentMethodField, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 380, 30));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 380, 160));

        jLabel3.setFont(new java.awt.Font("Sitka Text", 0, 14)); // NOI18N
        jLabel3.setText("Subtotal:");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 380, 110, 40));
        ...
        getContentPane().add(totalField, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 380, 140, 30));

        jLabel4.setFont(new java.awt.Font("Sitka Text", 0, 14)); // NOI18N
        jLabel4.setText("Shipping fee:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 440, -1, -1));

        shippingFeeField.setFont(new java.awt.Font("Sitka Text", 0, 12)); // NOI18N
        shippingFeeField.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        shippingFeeField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                shippingFeeFieldActionPerformed(evt);
            }
        });
        getContentPane().add(shippingFeeField, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 430, 140, 30));

        jLabel5.setFont(new java.awt.Font("Sitka Text", 1, 14)); // NOI18N
        jLabel5.setText("Order Total:");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 520, 90, 40));
        ...
        getContentPane().add(orderTotalField, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 530, 140, 30));

        jLabel6.setFont(new java.awt.Font("Sitka Text", 0, 14)); // NOI18N
        jLabel6.setText("Standard Delivery Time:");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 570, 170, 30));

        deliveryTimeField.setFont(new java.awt.Font("Sitka Text", 0, 12)); // NOI18N
        deliveryTimeField.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(deliveryTimeField, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 610, 380, 30));
        ...
        getContentPane().add(completeOrderbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 650, 380, 40));

        jLabel7.setFont(new java.awt.Font("Sitka Text", 0, 14)); // NOI18N
        jLabel7.setText("Vat:");
        jLabel7.setToolTipText("");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 490, 30, -1));

        jLabel8.setText("12%");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 480, 30, 30));
    ...
    private void loadCartItems() {
     ...
     private void setShippingFeeAndDeliveryTime() {
        shippingFeeField.setText("Php 65.00"); // Set the fixed shipping fee
        shippingFeeField.setEditable(false); // Make shippingFeeField non-editable

        deliveryTimeField.setText("15 to 30 minutes"); // Set the fixed delivery time
        deliveryTimeField.setEditable(false); // Make deliveryTimeField non-editable
    }
    private void calculateOrderTotal() {
        ...
        // Fixed shipping fee
        double shippingFee = 65.00;

        // Calculate VAT (12% of subtotal)
        double vat = subtotal * 0.12;

        // Calculate order total
        double orderTotal = subtotal + shippingFee + vat;
 ...
 // Show payment method selection dialog
    ...
    private void shippingFeeFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_shippingFeeFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_shippingFeeFieldActionPerformed
    ...
    // Check if the addressField and paymentMethodField are empty
...
private void writeDeliveryAddressToFile(String filePath, String address) {
    ...
    private javax.swing.JTextField shippingFeeField;
